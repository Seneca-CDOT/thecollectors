	...
	function gameLocation(img,typeIn) {
		this.loc=null; //the map Location of the Location
		this.botRight;
		this.points=null; //the points value of the Location
		this.image=img;
		this.labelClip=null;
		this.labelText=typeIn;
	}
	//set the location
	...
	gameLocation.prototype.getLoc=function(){
		return this.loc.clone(); //if someone got the actual loc, they could change it, so just return a clone
	};
